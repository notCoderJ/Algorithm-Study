...
> 다익스트라 알고리즘은 최단 경로를 찾기 위해 매번 '비용이 가장 적은 노드'를 선택하여 임의의 과정을 반복하고 최단 경로로 갱신하기 때문에 그리디 알고리즘으로 분류된다.
...
<div align="center">
<img src="../img/shortest_path.png" width="400px">
...
노드 간 중복 간선을 포함할 경우 v Ｐ ₂ = V(V - 1), 약 V²이므로 간선의 수(E)는 항상 E ≤ V²를 만족한다.<br>
...
**플로이드 워셜 알고리즘**은 그래프의 **모든 노드로부터 다른 모든 노드까지의 최단 경로**를 모두 구하는 알고리즘이다.

**TODO**<br>
<input type="checkbox"> 플로이드 워셜 내용 정리
